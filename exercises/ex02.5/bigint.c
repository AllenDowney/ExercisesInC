...
char *reverse_string(char *s) {
    ...
    char *s_rev = (char*)malloc((size+1) * sizeof(char));
...
// Unsure if c was an addend or something else because you added it in the
// example but the function definition says to add two digits
